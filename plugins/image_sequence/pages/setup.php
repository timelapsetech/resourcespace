...
$page_def[] = config_add_text_input('image_sequence_default_rep_frame', $lang['image_sequence_default_rep_frame']);
$page_def[] = config_add_boolean_select('image_sequence_ai_on_ingest', $lang['image_sequence_ai_on_ingest']);
